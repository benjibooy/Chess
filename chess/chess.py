...
#skapar variabel för brädan
board = [['  ' for i in range(8)] for i in range(8)]


#skapar lag så man inte kan döda sina egna pjäser
class Piece:    
...
#lägger pjäserna i ett lag och ger dem en bild
bp = Piece('b', 'p', 'bt/b-berserker-pawn.png')
wp = Piece('w', 'p', 'wt/w-berserker-pawn.png')
bk = Piece('b', 'k', 'bt/b-berserker-king.png')
wk = Piece('w', 'k', 'wt/w-berserker-king.png')
br = Piece('b', 'r', 'bt/b-berserker-rook.png')
wr = Piece('w', 'r', 'wt/w-berserker-rook.png')
bb = Piece('b', 'b', 'bt/b-berserker-bishop.png')
wb = Piece('w', 'b', 'wt/w-berserker-bishop.png')
bq = Piece('b', 'q', 'bt/b-berserker-queen.png')
wq = Piece('w', 'q', 'wt/w-berserker-queen.png')
bkn = Piece('b', 'kn', 'bt/b-berserker-knight.png')
wkn = Piece('w', 'kn', 'wt/w-berserker-knight.png')

#lägger pjäsen på rätt ruta
...
def create_board(board):
    board[0] = [Piece('b', 'r', 'bt/b-berserker-rook.png'), Piece('b', 'kn', 'bt/b-berserker-knight.png'), Piece('b', 'b', 'bt/b-berserker-bishop.png'), \
               Piece('b', 'q', 'bt/b-berserker-queen.png'), Piece('b', 'k', 'bt/b-berserker-king.png'), Piece('b', 'b', 'bt/b-berserker-bishop.png'), \
               Piece('b', 'kn', 'bt/b-berserker-knight.png'), Piece('b', 'r', 'bt/b-berserker-rook.png')]

    board[7] = [Piece('w', 'r', 'wt/w-berserker-rook.png'), Piece('w', 'kn', 'wt/w-berserker-knight.png'), Piece('w', 'b', 'wt/w-berserker-bishop.png'), \
               Piece('w', 'q', 'wt/w-berserker-queen.png'), Piece('w', 'k', 'wt/w-berserker-king.png'), Piece('w', 'b', 'wt/w-berserker-bishop.png'), \
               Piece('w', 'kn', 'wt/w-berserker-knight.png'), Piece('w', 'r', 'wt/w-berserker-rook.png')]

    for i in range(8):
        board[1][i] = Piece('b', 'p', 'bt/b-berserker-pawn.png')
        board[6][i] = Piece('w', 'p', 'wt/w-berserker-pawn.png')
    return board


# returnar inputen om den är innanför gränserna av brädan
def on_board(position):
    if position[0] > -1 and position[1] > -1 and position[0] < 8 and position[1] < 8:
        return True


# returnar en sting som placerar raderna och kolumnerna av brädan på ett läsbart sätt
...
# resetar "x'erna" och dem pjäserna man kan ta
def deselect():
...
# tar in brädan som ett argument och sen returnar den andra arrayn som innehåller de körbara dragen
def highlight(board):
    highlighted = []
...
# det här tar in ett pjäs object och dens index sen kör sen kollar vart den pjäsen kan gå genom att använda separata definierade funktioner för varje typ av pjäs
...
# kollar svarta och vita pjäser seprat och kollar rutan över dem om den är fri får det utrymmet ett x och om den är tagen av en pjäs från det andra laget blir den pjäsen tagbar
...
# det här kollar bara 3x3 rutan runt om kungen tomma rutor får ett x och om den är tagen av en pjäs från motståndar laget blir den pjäsen tagbar
...
# det här skapar 4 listor för upp ner vänster ovh höger och kollar alla dem rutorna efter pjäser från motståndar laget 
...
# lägger ihop tornet och löparen för att skapa drottningens drag
...
# kollar en 5x5 grid runt om pjäsen och använder pythagoras för att se om draget är lagligt 
